...
pub fn remove_unreachable_areas_returning_most_distant(map: &mut Map, start_idx: usize) -> usize {
    ...
    let dijkstra_map =
        rltk::DijkstraMap::new(map.width as usize, map.height as usize, &map_starts, map, 200.0);
...
/// Generate a Voronoi/cellular noise map of a region, and divides it into spawn regions.
