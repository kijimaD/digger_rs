use specs::prelude::*;
use super::{Viewshed, Bystander, Map, Position, RunState, EntityMoved, Point, gamelog::GameLog, Quips, Name};
...
impl<'a> System<'a> for BystanderAI {
    ...
    fn run(&mut self, data: Self::SystemData) {
        let (mut map, runstate, entities, mut viewshed, bystander, mut position, mut entity_moved,
             mut rng, player_pos, mut gamelog, mut quips, names) = data;
